...
<div class="register-box">
    <div class="register-logo">
        ...
        <a href="#"><b>在线考试系统</b>——修改信息</a>

    </div>

    <div class="register-box-body">
        <p class="login-box-msg">修改个人信息</p>

        <form action="${pageContext.request.contextPath}/changeinfo" method="post">
            <div class="form-group has-feedback">
                <input name="newusername" type="text" class="form-control" placeholder="新昵称">
        ...
        <a href="/jsp/web-index.jsp" class="text-center">我不想改了</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
