...
<div class="wrapper">
    ...
    <!-- 页面头部 -->
    <jsp:include page="manager-header.jsp"></jsp:include>
    <!-- 页面头部 /-->

    <!-- 导航侧栏 -->
    <jsp:include page="manager-aside.jsp"></jsp:include>
    <!-- 导航侧栏 /-->
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="all-order-manage-list.html">题目管理</a></li>
    ...
    <!-- 底部导航 -->
    <jsp:include page="all-footer.jsp"></jsp:include>
    <!-- 底部导航 /-->
